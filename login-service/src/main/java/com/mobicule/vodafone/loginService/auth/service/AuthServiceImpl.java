...
public class AuthServiceImpl implements AuthService {
    ...
    public AuthServiceImpl(KeycloakTokenUtil keycloakTokenUtil) {
    ...
    public Response generateOtp(Request request) {
        ...
        {
            log.error("Error in generateotp", e);
    ...
    @Override
    public Response verifyPassword(Request request) {
        try {
            ...
            keycloakUserService.invalidateUserSessions(username);
    ...
    @Override
    public Response setPassword(Request request) {
